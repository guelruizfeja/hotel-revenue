              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    const canalMap2 = {};
                    for (const p of (pickupMes2 || [])) { const key = isOTA2(p.canal) ? 'OTAs' : (p.canal || 'Directo / Web'); const peso = p.precio_total || (p.num_reservas || 1); canalMap2[key] = (canalMap2[key] || 0) + peso; }
